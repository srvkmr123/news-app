...
const Business = () => { let [news,setNews]=useState([])
  ...
  useEffect(()=>{
     const getNews=async()=>{
      try{
        ...
        let res=await axios.get(`https://newsapi.org/v2/everything?q=business&from=${today}&to=${today}&sortBy=popularity&apiKey=${process.env.REACT_APP_API_KEY}`)
